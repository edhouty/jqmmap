  ...
  <tr>
    <td width="150" align="left" valign="top"><div class="Menu_Kiri">
      <ul>
        ...
        <li><a href="menu_alamat.php">Menu Data Alamat</a></li>
        <li><a href="../admin_logout.php">Logout</a></li>
      </ul>
    </div></td>
    <td width="650" align="center" valign="top"><div class="Menu_Tengah"><table width="100%" border="0" cellspacing="0" cellpadding="0">
     <tr>
    <th align="left" valign="top" class="Teks_Keterangan" scope="col">Menu Data Alamat</th>
  </tr>
    <tr>
    <td align="center" valign="top" scope="col"><hr/></td>
  </tr>
  <tr>
    <td align="center" valign="top" scope="col"><?php include "Input_Alamat.php" ?></td>
  </tr>
  <tr>
    <td align="center" valign="top"><hr /></td>
  </tr>
  <tr>
    <td align="center" valign="top"><?php include "Data_Alamat.php" ?></td>
  </tr>
    </table>
</div></td>
  </tr>
